...
test("provider registry exposes configured API and OAuth model families", () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "commandcode-oauth/deepseek-v4-flash",
      "commandcode-oauth/deepseek-v4-pro",
      "commandcode-oauth/fugu-ultra",
      "commandcode-oauth/gemini-3.5-flash",
      "commandcode-oauth/gemini-3.7-flash",
      "commandcode-oauth/glm-5.2-fast",
      "commandcode-oauth/glm-5.2",
      "commandcode-oauth/gpt-5.5",
      "commandcode-oauth/gpt-5.6-luna",
      "commandcode-oauth/gpt-5.6-sol",
      "commandcode-oauth/gpt-5.6-terra",
      "commandcode-oauth/grok-4.5",
      "commandcode-oauth/grok-4.6",
      "commandcode-oauth/hy3-paid",
      "commandcode-oauth/inkling-small",
      "commandcode-oauth/inkling",
      "commandcode-oauth/kimi-k2.7-code-highspeed",
      "commandcode-oauth/kimi-k2.7-code",
      "commandcode-oauth/kimi-k3",
      "commandcode-oauth/laguna-s-2.1",
      "commandcode-oauth/mimo-v2.5-pro",
      "commandcode-oauth/minimax-m2.7",
      "commandcode-oauth/minimax-m3",
      "commandcode-oauth/muse-spark-1.2",
      "commandcode-oauth/nemotron-3-ultra",
      "commandcode-oauth/ox-alpha",
      "commandcode-oauth/qwen3.7-flash",
      "commandcode-oauth/qwen3.7-max",
      "commandcode-oauth/qwen3.7-plus",
      "commandcode-oauth/qwen3.8-max",
      "commandcode-oauth/qwen3.8-flash",
      "commandcode-oauth/step-3.7-flash",
      "commandcode-oauth/deepseek/deepseek-v4-flash-vision-exp",
      "commandcode-oauth/glm-5.3-flash",
      "commandcode-oauth-messages/claude-fable-5",
      "commandcode-oauth-messages/claude-haiku-4.5",
      "commandcode-oauth-messages/claude-opus-4.8",
      "commandcode-oauth-messages/claude-opus-5",
      "commandcode-oauth-messages/claude-sonnet-5",
