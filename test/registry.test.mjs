...
test("provider registry exposes configured API and OAuth model families", () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "commandcode-api-messages/claude-fable-5",
      "commandcode-api-messages/claude-haiku-4.5",
      "commandcode-api-messages/claude-opus-4.8",
      "commandcode-api-messages/claude-opus-5",
      "commandcode-api-messages/claude-sonnet-5",
